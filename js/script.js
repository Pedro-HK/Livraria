(function () {
  ...
  $novo_livro.addEventListener('click', () => {
    ...
    const $cancelar = document.querySelector('.container_botoes .botao_cancelar');
  ...
  `;
    ...
    function putBooks(books) {
      books.forEach((book) => {
        ...
        card_selected_infos.innerHTML = generateInfosBook(book, 'botao_emprestar', 'Emprestar', 'Inativar', 'inativar');

        card_selected_emprestado.innerHTML = generateInfosBook(book, 'botao_devolver', 'Devolver', 'Inativar', 'inativar');

        card_selected_inativado.innerHTML = generateInfosBook(book, '', 'Emprestar', 'Ativar', 'ativar');
        ...
        card_book.addEventListener('click', () => {
          ...
          const $botao_inativar = document.querySelector('.selected_book_infos .botao_inativar');
          const $botao_emprestar = document.querySelector('.selected_book_infos .botao_emprestar');
          const $botao_editar = document.querySelector('.botao_editar');

          //Mostra as informações atualizadas

          if (card_selected_emprestado.classList.contains('livro_selecionado_emprestado') && book.title === nome_livro.textContent) {
            $selected_book.removeChild(card_selected_infos);
            $selected_book.removeChild(card_selected_inativado);
          } else if (book.status.isActive === false && nome_livro.textContent === book.title) {
            $selected_book.removeChild(card_selected_infos);
          ...
          const botao_historico = document.querySelector('.selected_book_infos .botao_historico');
          const icone_fechar = document.querySelector('.selected_book_infos .icone_fechar');
          ...
          $botao_ativar.addEventListener('click', () => {
            ...
            const icone_fechar_2 = document.querySelector('.selected_book_infos .icone_fechar');
          ...
          $botao_inativar.addEventListener('click', () => {
            ...
            const $texto_inativacao = document.querySelector('.selected_book_inativar #text_inativar');

            const icone_fechar_5 = document.querySelector('.selected_book_inativar .icone_fechar');
            const $botao_inativar_2 = document.querySelector('.selected_book_inativar .botao_inativar');
            ...
            $botao_inativar_2.addEventListener('click', () => {
              if ($texto_inativacao.value !== '') {
                ...
                const icone_fechar_6 = document.querySelector('.selected_book_inativado .icone_fechar');
          ...
          $botao_emprestar.addEventListener('click', () => {
            ...
            const icone_fechar_2 = document.querySelector('.selected_book_emprestar .icone_fechar');

            close(icone_fechar_2);

            const $nome = document.querySelector('.selected_book_emprestar #nome');
            const $turma = document.querySelector('.selected_book_emprestar #turma');
            ...
            $emprestar_2.addEventListener('click', () => {
              if ($nome.value !== '' && $turma.value !== '' && $dataEntrega.value !== '' && $dataRetirada.value !== '') {
                ...
                let changedWithdrawal = inputWithdrawal.toLocaleDateString('pt-BR', { timeZone: 'UTC' });
                let changedDelivery = inputDelivery.toLocaleDateString('pt-BR', { timeZone: 'UTC' });
                ...
                card_selected_emprestado.classList.add('livro_selecionado_emprestado');
                ...
                const icone_fechar_3 = document.querySelector('.selected_book_infos_2 .icone_fechar');

                const $devolver = document.querySelector('.selected_book_infos .botao_devolver');
                ...
                $devolver.addEventListener('click', () => {
                  ...
                  card_selected_emprestado.classList.remove('livro_selecionado_emprestado');
          ...
          $botao_editar.addEventListener('click', () => {
            ...
            const $cancelar = document.querySelector('.pagina_editar .botao_cancelar');
            ...
            $salvar.addEventListener('click', () => {
              ...
              if ($titulo_2.value !== '' && $sinopse_2.value !== '' && $autor_2.value !== '' && $data_2.value !== '' && $genero_2.value !== '') {
